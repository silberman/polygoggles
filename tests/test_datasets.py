...
from polygoggles.datasets import (get_image_filenames_of_size,
                                  extract_images_and_labels,
                                  get_image_info_from_filename)
...
class Test_extract_images_and_labels(unittest.TestCase):
    ...
    def test_extract_images_and_labels(self):
        ...
        images_4D_array, labels = extract_images_and_labels(train_dir, 28, 28)

        # Make sure these numpy arrays are the right shape
        expected_images_array_shape = (8, 28, 28, 1)
        expected_labels_shape = (8, 10)
